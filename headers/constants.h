...
public:
  ...
  static constexpr double   BETA_DEFAULT          = 2.0;
  static constexpr double   LAMBDA_DEFAULT        = 0.2;
  static constexpr unsigned SOURCES_DEFAULT       = 4;
  static constexpr unsigned CONSUMERS_DEFAULT     = 2;
  static constexpr unsigned BUFFER_DEFAULT        = 2;
  static constexpr unsigned MIN_REQUESTS_DEFAULT  = 5;
  static constexpr bool STEP_BY_STEP_MODE_DEFAULT = false;
